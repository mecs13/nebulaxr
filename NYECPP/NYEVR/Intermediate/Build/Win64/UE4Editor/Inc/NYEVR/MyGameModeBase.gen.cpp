...
#include "NYEVR/MyGameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	NYEVR_API UClass* Z_Construct_UClass_AMyGameModeBase_NoRegister();
	NYEVR_API UClass* Z_Construct_UClass_AMyGameModeBase();
	ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
	UPackage* Z_Construct_UPackage__Script_NYEVR();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyGameModeBase_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_NYEVR,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyGameModeBase, 1768310993);
	template<> NYEVR_API UClass* StaticClass<AMyGameModeBase>()
	{
		return AMyGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyGameModeBase(Z_Construct_UClass_AMyGameModeBase, &AMyGameModeBase::StaticClass, TEXT("/Script/NYEVR"), TEXT("AMyGameModeBase"), false, nullptr, nullptr, nullptr);
