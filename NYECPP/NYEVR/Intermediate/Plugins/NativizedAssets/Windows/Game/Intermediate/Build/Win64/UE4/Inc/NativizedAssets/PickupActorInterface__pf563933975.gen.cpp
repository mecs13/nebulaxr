...
// End Cross Module References
	void IPickupActorInterface_C::bpf__AltRelease__pf()
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_bpf__AltRelease__pf instead.");
	}
	...
	void IPickupActorInterface_C::bpf__Release__pf()
	{
	...
	struct Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf_Statics::Function_MetaDataParams[] = {
		{ "Category", "" },
		{ "ModuleRelativePath", "Public/PickupActorInterface__pf563933975.h" },
		{ "OverrideNativeName", "AltRelease" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPickupActorInterface_C, nullptr, "AltRelease", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf()
	{
		...
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf_Statics::Function_MetaDataParams[] = {
		{ "Category", "" },
		{ "ModuleRelativePath", "Public/PickupActorInterface__pf563933975.h" },
		{ "OverrideNativeName", "Release" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPickupActorInterface_C, nullptr, "Release", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf()
	{
		UObject* Outer = Z_Construct_UClass_UPickupActorInterface_C();
		UFunction* ReturnFunction = static_cast<UFunction*>(StaticFindObjectFast( UFunction::StaticClass(), Outer, TEXT("Release") ));
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPickupActorInterface_C_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPickupActorInterface_C_bpf__AltRelease__pf, "AltRelease" }, // 3728620311
		{ &Z_Construct_UFunction_UPickupActorInterface_C_bpf__Pickup__pf, "Pickup" }, // 713045704
		{ &Z_Construct_UFunction_UPickupActorInterface_C_bpf__Release__pf, "Release" }, // 4187572150
	};
#if WITH_METADATA
	...
	IMPLEMENT_DYNAMIC_CLASS(UPickupActorInterface_C, TEXT("PickupActorInterface_C"), 3015223548);
	...
	static FName NAME_UPickupActorInterface_C_bpf__AltRelease__pf = FName(TEXT("AltRelease"));
	void IPickupActorInterface_C::Execute_bpf__AltRelease__pf(UObject* O)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UPickupActorInterface_C::StaticClass()));
		UFunction* const Func = O->FindFunction(NAME_UPickupActorInterface_C_bpf__AltRelease__pf);
		if (Func)
		{
	...
	static FName NAME_UPickupActorInterface_C_bpf__Release__pf = FName(TEXT("Release"));
	void IPickupActorInterface_C::Execute_bpf__Release__pf(UObject* O)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UPickupActorInterface_C::StaticClass()));
		UFunction* const Func = O->FindFunction(NAME_UPickupActorInterface_C_bpf__Release__pf);
		if (Func)
		{
			O->ProcessEvent(Func, NULL);
		}
