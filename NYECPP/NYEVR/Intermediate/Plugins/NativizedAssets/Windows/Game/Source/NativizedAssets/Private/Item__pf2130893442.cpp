...
AItem_C__pf2130893442::AItem_C__pf2130893442(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__0 = (*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeScale3D() )));
	...
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Sphere__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__3 = FVector(0.700000, 0.700000, 0.700000);
	...
	bpv__PointLight__pf->SourceRadius = 2.654644f;
	bpv__PointLight__pf->SoftSourceRadius = 1.576001f;
	bpv__PointLight__pf->SourceLength = 2.504762f;
	bpv__PointLight__pf->AttenuationRadius = 960.157898f;
	bpv__PointLight__pf->Intensity = 100000.000000f;
	...
	{
		__Local__4 = (AActor::StaticClass())->FindPropertyByName(FName(TEXT("bReplicateMovement")));
		check(__Local__4);
...
void AItem_C__pf2130893442::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AItem_C__pf2130893442::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	extern UClass* Z_Construct_UClass_UInteractInterface_C();
	InDynamicClass->ReferencedConvertedFields.Add(Z_Construct_UClass_UInteractInterface_C());
	// List of all referenced converted structures
	extern UScriptStruct* Z_Construct_UScriptStruct_FItemStructure__pf1634840482();
	InDynamicClass->ReferencedConvertedFields.Add(Z_Construct_UScriptStruct_FItemStructure__pf1634840482());
...
PRAGMA_ENABLE_OPTIMIZATION
void AItem_C__pf2130893442::bpf__ExecuteUbergraph_Item__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf = Cast<AMotionControllerPawn_C__pf563933975>(b0l__K2Node_Event_OtherActor__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	USaveGame*  __Local__10 = ((USaveGame*)nullptr);
	b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf = Cast<UPlayerSaveGameInfo_C__pf205484891>(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__SaverSubClass__pf) : (__Local__10)));
	...
	int32  __Local__11 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf)) ? (b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf->bpv__GameCurrency__pf) : (__Local__11)), 1);
	...
	{
		b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf->bpv__GameCurrency__pf = b0l__Temp_int_Variable_1__pf;
	}
	int32  __Local__12 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__GameCurrency__pf) : (__Local__12)), 1);
	...
	{
		b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__GameCurrency__pf = b0l__Temp_int_Variable__pf;
	}
	USaveGame*  __Local__13 = ((USaveGame*)nullptr);
	bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf = UGameplayStatics::SaveGameToSlot(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__SaverSubClass__pf) : (__Local__13)), FString(TEXT("test")), 0);
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Increased & Saved")), bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	// optimized KCST_UnconditionalGoto
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AItem_C__pf2130893442::bpf__ExecuteUbergraph_Item__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 3);
	// optimized KCST_UnconditionalGoto
	bpf__OverlapItem__pf();
	return; // KCST_GotoReturn
}
void AItem_C__pf2130893442::bpf__ExecuteUbergraph_Item__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	return; // KCST_GotoReturn
}
void AItem_C__pf2130893442::bpf__OverlapItem__pf_Implementation()
{
	bpf__ExecuteUbergraph_Item__pf_0(13);
}
void AItem_C__pf2130893442::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Item__pf_1(3);
}
void AItem_C__pf2130893442::bpf__Interact__pf()
{
	bpf__ExecuteUbergraph_Item__pf_2(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AItem_C__pf2130893442::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AItem_C__pf2130893442::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{317, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/SoftInventory/InteractInterface.InteractInterface_C 
		...
		{318, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedStruct /Game/SoftInventory/ItemStructure.ItemStructure 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AItem_C__pf2130893442
{
	FRegisterHelper__AItem_C__pf2130893442()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/SoftInventory/Items/Item"), &AItem_C__pf2130893442::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AItem_C__pf2130893442 Instance;
};
FRegisterHelper__AItem_C__pf2130893442 FRegisterHelper__AItem_C__pf2130893442::Instance;
