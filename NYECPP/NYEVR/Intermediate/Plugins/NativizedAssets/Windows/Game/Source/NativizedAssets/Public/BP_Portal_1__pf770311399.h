...
#include "BP_Portal_1__pf770311399.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HQportals/Blueprints/BP_Portal_1.BP_Portal_1_C", OverrideNativeName="BP_Portal_1_C"))
class ABP_Portal_1_C__pf770311399 : public AStaticMeshActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="P_InsideTrails"))
	UParticleSystemComponent* bpv__P_InsideTrails__pf;
	...
	ABP_Portal_1_C__pf770311399(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_Portal_1__pf_0(int32 bpp__EntryPoint__pf);
