...
#include "BP_Portal_7__pf770311399.h"
...
ABP_Portal_7_C__pf770311399::ABP_Portal_7_C__pf770311399(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Portal_7_C__pf770311399::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__0->OverrideMaterials = TArray<UMaterialInterface*> ();
		__Local__0->OverrideMaterials.Reserve(1);
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Portal_7_C__pf770311399::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__P_RotatingSmoke__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("P_RotatingSmoke"));
	...
	bpv__PointLight__pf->LightColor = FColor(236, 226, 255, 255);
	...
	auto& __Local__7 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__SM_QuadToCircle2__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__7 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Portal_7_C__pf770311399::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	bpv__SM_QuadToCircle2__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Portal_7_C__pf770311399::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
	bpv__SM_QuadToCircle2__pf->TranslucencySortPriority = -1;
	bpv__SM_QuadToCircle2__pf->SetCollisionProfileName(FName(TEXT("BlockAll")));
	auto& __Local__8 = (*(AccessPrivateProperty<FVector >((bpv__SM_QuadToCircle2__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__8 = FVector(0.000000, 0.000000, 200.000000);
	auto& __Local__9 = (*(AccessPrivateProperty<FRotator >((bpv__SM_QuadToCircle2__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__9 = FRotator(0.000000, 0.000000, 89.999985);
	auto& __Local__10 = (*(AccessPrivateProperty<FVector >((bpv__SM_QuadToCircle2__pf), USceneComponent::__PPO__RelativeScale3D() )));
	...
	bpv__P_RotatingSmoke__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__P_RotatingSmoke__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__P_RotatingSmoke__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ABP_Portal_7_C__pf770311399::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__11 = (*(AccessPrivateProperty<FVector >((bpv__P_RotatingSmoke__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__11 = FVector(0.000000, 0.000000, 200.000000);
	bpv__P_RotatingSmoke__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__5)->SetPropertyValue_InContainer((bpv__P_RotatingSmoke__pf), false, 0));
	...
	auto& __Local__12 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeLocation() )));
	...
	__Local__13 = FVector(4.750000, 0.250000, 4.750000);
...
void ABP_Portal_7_C__pf770311399::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Portal_7_C__pf770311399::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__20.ComponentPropertyName = FName(TEXT("Box"));
	__Local__20.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__20.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Portal_7_C__pf770311399::bpf__ExecuteUbergraph_BP_Portal_7__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpfv__CallFunc_K2_SetActorLocation_ReturnValue__pf = b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->AActor::K2_SetActorLocation(FVector(-32250.000000,-6835.000000,75320.000000), false, /*out*/ b0l__CallFunc_K2_SetActorLocation_SweepHitResult__pf, false);
	}
	return; // KCST_GotoReturn
}
void ABP_Portal_7_C__pf770311399::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_Portal_7__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Portal_7_C__pf770311399::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{304, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/HQportals/Materials/MI_PortalMat6.MI_PortalMat6 
		...
		{305, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/HQportals/Materials/M_NoiseDistortion.M_NoiseDistortion 
		{306, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ParticleSystem /Game/HQportals/ParticleSystems/PS_RotatingSmoke.PS_RotatingSmoke 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Portal_7_C__pf770311399::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Portal_7_C__pf770311399
{
	FRegisterHelper__ABP_Portal_7_C__pf770311399()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HQportals/Blueprints/BP_Portal_7"), &ABP_Portal_7_C__pf770311399::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Portal_7_C__pf770311399 Instance;
};
FRegisterHelper__ABP_Portal_7_C__pf770311399 FRegisterHelper__ABP_Portal_7_C__pf770311399::Instance;
