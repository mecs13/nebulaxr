...
class AActor;
#include "Spawner__pf1010915279.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Spawner.Spawner_C", OverrideNativeName="Spawner_C"))
class ASpawner_C__pf1010915279 : public AActor
{
public:
	GENERATED_BODY()
	...
	ASpawner_C__pf1010915279(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Spawner_0"))
	void bpf__ExecuteUbergraph_Spawner__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Spawner__pf_1(int32 bpp__EntryPoint__pf);
