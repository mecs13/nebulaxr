...
ATeleport_C__pf643803050::ATeleport_C__pf643803050(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Widget__pf = CreateDefaultSubobject<UWidgetComponent>(TEXT("Widget"));
	RootComponent = bpv__Widget__pf;
	...
	__Local__0 = UTeleportMenu_C__pf643803050::StaticClass();
	...
	(((FBoolProperty*)__Local__2)->SetPropertyValue_InContainer((bpv__Widget__pf), true, 0));
...
void ATeleport_C__pf643803050::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ATeleport_C__pf643803050::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UTeleportMenu_C__pf643803050::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATeleport_C__pf643803050::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATeleport_C__pf643803050::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{25, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.WidgetComponent 
		...
		{117, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/MapData/TeleportMenu.TeleportMenu_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ATeleport_C__pf643803050
{
	FRegisterHelper__ATeleport_C__pf643803050()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/MapData/Teleport"), &ATeleport_C__pf643803050::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ATeleport_C__pf643803050 Instance;
};
FRegisterHelper__ATeleport_C__pf643803050 FRegisterHelper__ATeleport_C__pf643803050::Instance;
