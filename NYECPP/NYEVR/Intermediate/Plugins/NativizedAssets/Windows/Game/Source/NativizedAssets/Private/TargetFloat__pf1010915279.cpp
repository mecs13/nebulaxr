...
ATargetFloat_C__pf1010915279::ATargetFloat_C__pf1010915279(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ATargetFloat_C__pf1010915279::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ATargetFloat_C__pf1010915279::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void ATargetFloat_C__pf1010915279::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ATargetFloat_C__pf1010915279::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ATargetFloat_C__pf1010915279::bpf__ExecuteUbergraph_TargetFloat__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ATargetFloat_C__pf1010915279::bpf__ExecuteUbergraph_TargetFloat__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsBP_Base_Arrow__pf = Cast<ABP_BaseArrow_C__pf4190551111>(b0l__K2Node_Event_Other__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBP_Base_Arrow__pf != nullptr);;
	...
	int32  __Local__10 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__Score__pf) : (__Local__10)), 10);
	if(::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf))
	{
		b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__Score__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	}
	USaveGame*  __Local__11 = ((USaveGame*)nullptr);
	b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf = Cast<UPlayerSaveGameInfo_C__pf205484891>(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__SaverSubClass__pf) : (__Local__11)));
	...
	{
		b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf->bpv__Score__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__Score__pf) : (__Local__12));
	}
	...
	// optimized KCST_UnconditionalGoto
	bpf__TargetDestroy__pf();
	return; // KCST_GotoReturn
}
void ATargetFloat_C__pf1010915279::bpf__TargetDestroy__pf_Implementation()
{
	bpf__ExecuteUbergraph_TargetFloat__pf_0(10);
}
void ATargetFloat_C__pf1010915279::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	typedef FHitResult  T__Local__14;
	T__Local__14& bpp__Hit__pf = *const_cast<T__Local__14 *>(&bpp__Hit__pf__const);
	...
	bpf__ExecuteUbergraph_TargetFloat__pf_1(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void ATargetFloat_C__pf1010915279::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATargetFloat_C__pf1010915279::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ATargetFloat_C__pf1010915279
{
	FRegisterHelper__ATargetFloat_C__pf1010915279()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TargetFloat"), &ATargetFloat_C__pf1010915279::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ATargetFloat_C__pf1010915279 Instance;
};
FRegisterHelper__ATargetFloat_C__pf1010915279 FRegisterHelper__ATargetFloat_C__pf1010915279::Instance;
