...
ABP_Stars_C__pf2036008057::ABP_Stars_C__pf2036008057(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Stars_C__pf2036008057::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Stars_C__pf2036008057::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__2 = FVector(99999997952.000000, 99999997952.000000, 99999997952.000000);
...
void ABP_Stars_C__pf2036008057::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Stars_C__pf2036008057::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Stars_C__pf2036008057::bpf__ExecuteUbergraph_BP_Stars__pf_0(int32 bpp__EntryPoint__pf)
{
	FRotator bpfv__CallFunc_Multiply_RotatorFloat_ReturnValue__pf(EForceInit::ForceInit);
	FRotator bpfv__CallFunc_Multiply_RotatorFloat_ReturnValue_1__pf(EForceInit::ForceInit);
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Multiply_RotatorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_RotatorFloat(FRotator(0.200000,0.000000,0.200000), b0l__K2Node_Event_DeltaSeconds__pf);
	bpfv__CallFunc_Multiply_RotatorFloat_ReturnValue_1__pf = UKismetMathLibrary::Multiply_RotatorFloat(bpfv__CallFunc_Multiply_RotatorFloat_ReturnValue__pf, 0.010000);
	AActor::K2_AddActorWorldRotation(bpfv__CallFunc_Multiply_RotatorFloat_ReturnValue_1__pf, false, /*out*/ b0l__CallFunc_K2_AddActorWorldRotation_SweepHitResult__pf, false);
	return; // KCST_GotoReturn
}
void ABP_Stars_C__pf2036008057::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_Stars__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Stars_C__pf2036008057::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Stars_C__pf2036008057::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Stars_C__pf2036008057
{
	FRegisterHelper__ABP_Stars_C__pf2036008057()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Earth32/Blueprint/BP_Stars"), &ABP_Stars_C__pf2036008057::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Stars_C__pf2036008057 Instance;
};
FRegisterHelper__ABP_Stars_C__pf2036008057 FRegisterHelper__ABP_Stars_C__pf2036008057::Instance;
