...
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Pointer"))
	UStaticMeshComponent* bpv__Pointer__pf;
	...
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_0"))
	virtual void bpf__InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_0__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_1"))
	virtual void bpf__InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_1__pf(FKey bpp__Key__pf);
