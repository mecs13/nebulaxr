...
ABP_MotionController_C__pf563933975::ABP_MotionController_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Pointer__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Pointer"));
	...
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__HandMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__3.AddUninitialized(3);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__3.GetData(), 3);
	...
	__Local__6.Channel = FName(TEXT("Weapon"));
	__Local__6.Response = ECollisionResponse::ECR_Ignore;
	bpv__HandMesh__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__HandMesh__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(-12.785664, -0.028015, -1.789026);
	auto& __Local__8 = (*(AccessPrivateProperty<FRotator >((bpv__HandMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	...
	auto& __Local__9 = (*(AccessPrivateProperty<FVector >((bpv__ArcDirection__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__9 = FVector(14.175764, 0.859525, -4.318897);
	...
	auto& __Local__10 = (*(AccessPrivateProperty<FVector >((bpv__ArcSpline__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__10 = FVector(12.532683, -1.756977, 2.553327);
	...
	auto& __Local__11 = (*(AccessPrivateProperty<float >((bpv__GrabSphere__pf), USphereComponent::__PPO__SphereRadius() )));
	__Local__11 = 10.000000f;
	bpv__GrabSphere__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__12 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__GrabSphere__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__13.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__13.GetData(), 9);
	...
	__Local__22.Channel = FName(TEXT("Weapon"));
	__Local__22.Response = ECollisionResponse::ECR_Overlap;
	bpv__GrabSphere__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__23 = (*(AccessPrivateProperty<FVector >((bpv__GrabSphere__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__23 = FVector(14.286342, 0.224237, 1.484932);
	...
	bpv__WidgetInteraction__pf->InteractionDistance = 80000.000000f;
	auto& __Local__24 = (*(AccessPrivateProperty<FVector >((bpv__WidgetInteraction__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__24 = FVector(12.785664, -1.789025, 0.028015);
	auto& __Local__25 = (*(AccessPrivateProperty<FRotator >((bpv__WidgetInteraction__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__25 = FRotator(0.000000, 0.000000, -89.999992);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__WidgetInteraction__pf), false, 0));
	bpv__Pointer__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Pointer__pf->AttachToComponent(bpv__HandMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__26 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Pointer__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__26 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Pointer__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Pointer__pf->OverrideMaterials.Reserve(1);
	bpv__Pointer__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	auto& __Local__27 = (*(AccessPrivateProperty<FVector >((bpv__Pointer__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__27 = FVector(402.785645, -1.789025, 0.028015);
	auto& __Local__28 = (*(AccessPrivateProperty<FRotator >((bpv__Pointer__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__28 = FRotator(0.000000, 0.000000, -89.999992);
	auto& __Local__29 = (*(AccessPrivateProperty<FVector >((bpv__Pointer__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__29 = FVector(800.000000, 1.000000, 1.000000);
	...
	(((FBoolProperty*)__Local__30)->SetPropertyValue_InContainer((bpv__Pointer__pf), false, 0));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Pointer__pf), true, 0));
	...
	__Local__32 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	bpv__ArcEndPoint__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ArcEndPoint__pf->OverrideMaterials.Reserve(1);
	bpv__ArcEndPoint__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	...
	(((FBoolProperty*)__Local__30)->SetPropertyValue_InContainer((bpv__ArcEndPoint__pf), false, 0));
	...
	auto& __Local__42 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__TeleportCylinder__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__42 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	...
	bpv__TeleportCylinder__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
	bpv__TeleportCylinder__pf->SetCollisionProfileName(FName(TEXT("NoCollision")));
	auto& __Local__43 = (*(AccessPrivateProperty<FVector >((bpv__TeleportCylinder__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__43 = FVector(0.750000, 0.750000, 1.000000);
	...
	auto& __Local__44 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Ring__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__44 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	bpv__Ring__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Ring__pf->OverrideMaterials.Reserve(1);
	bpv__Ring__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	auto& __Local__45 = (*(AccessPrivateProperty<FVector >((bpv__Ring__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__45 = FVector(0.500000, 0.500000, 0.150000);
	...
	auto& __Local__46 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Arrow__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__46 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	bpv__Arrow__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Arrow__pf->OverrideMaterials.Reserve(1);
	bpv__Arrow__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	...
	auto& __Local__47 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__RoomScaleMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__47 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	bpv__RoomScaleMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__RoomScaleMesh__pf->OverrideMaterials.Reserve(1);
	bpv__RoomScaleMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
...
void ABP_MotionController_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__49 = NewObject<USplineMeshComponent>(InDynamicClass, USplineMeshComponent::StaticClass(), TEXT("NODE_AddSplineMeshComponent-0"), (EObjectFlags)0x00280029);
	InDynamicClass->ComponentTemplates.Add(__Local__49);
	auto __Local__50 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_REMOVED_73604AB8494A4F511B55F0A4F1A85DC7"), (EObjectFlags)0x00280029);
	InDynamicClass->ComponentTemplates.Add(__Local__50);
	auto __Local__51 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__51);
	auto __Local__52 = NewObject<UInputActionDelegateBinding>(InDynamicClass, UInputActionDelegateBinding::StaticClass(), TEXT("InputActionDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__52);
	__Local__49->SplineParams.StartScale = FVector2D(4.000000, 4.000000);
	__Local__49->SplineParams.EndScale = FVector2D(4.000000, 4.000000);
	__Local__49->SplineBoundaryMax = 1.000000f;
	auto& __Local__53 = (*(AccessPrivateProperty<UStaticMesh* >((__Local__49), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__53 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[11], ECastCheckedType::NullAllowed);
	__Local__49->OverrideMaterials = TArray<UMaterialInterface*> ();
	__Local__49->OverrideMaterials.Reserve(1);
	__Local__49->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[12], ECastCheckedType::NullAllowed));
	__Local__49->Mobility = EComponentMobility::Type::Movable;
	...
	(((FBoolProperty*)__Local__54)->SetPropertyValue_InContainer((__Local__49), true, 0));
	(((FBoolProperty*)__Local__54)->SetPropertyValue_InContainer((__Local__50), false, 0));
	__Local__51->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__51->ComponentDelegateBindings.AddUninitialized(2);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__51->ComponentDelegateBindings.GetData(), 2);
	auto& __Local__56 = __Local__51->ComponentDelegateBindings[0];
	__Local__56.ComponentPropertyName = FName(TEXT("ControllerMesh"));
	__Local__56.DelegatePropertyName = FName(TEXT("OnComponentHit"));
	__Local__56.FunctionNameToBind = FName(TEXT("BndEvt__ControllerMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
	auto& __Local__57 = __Local__51->ComponentDelegateBindings[1];
	...
	__Local__52->InputActionDelegateBindings = TArray<FBlueprintInputActionDelegateBinding> ();
	__Local__52->InputActionDelegateBindings.AddUninitialized(2);
	FBlueprintInputActionDelegateBinding::StaticStruct()->InitializeStruct(__Local__52->InputActionDelegateBindings.GetData(), 2);
	auto& __Local__58 = __Local__52->InputActionDelegateBindings[0];
	__Local__58.InputActionName = FName(TEXT("MotionControllerTrackpadDownRight"));
	__Local__58.InputKeyEvent = EInputEvent::IE_Released;
	__Local__58.FunctionNameToBind = FName(TEXT("InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_1"));
	auto& __Local__59 = __Local__52->InputActionDelegateBindings[1];
	__Local__59.InputActionName = FName(TEXT("MotionControllerTrackpadDownRight"));
	__Local__59.FunctionNameToBind = FName(TEXT("InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_0"));
}
PRAGMA_ENABLE_OPTIMIZATION
...
void ABP_MotionController_C__pf563933975::bpf__ExecuteUbergraph_BP_MotionController__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpfv__CallFunc_GetPlayerController_ReturnValue__pf->APlayerController::PlayHapticEffect(CastChecked<UHapticFeedbackEffect_Base>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[13], ECastCheckedType::NullAllowed), bpv__Hand__pf, b0l__K2Node_CustomEvent_Intensity__pf, false);
	}
...
void ABP_MotionController_C__pf563933975::bpf__ExecuteUbergraph_BP_MotionController__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__WidgetInteraction__pf))
	{
		const UScriptStruct* __Local__61 = FKey::StaticStruct();
		uint8* __Local__62 = (uint8*)FMemory_Alloca(__Local__61->GetStructureSize());
		__Local__61->InitializeStruct(__Local__62);
		FKey& __Local__60 = *reinterpret_cast<FKey*>(__Local__62);
		auto& __Local__63 = (*(AccessPrivateProperty<FName >(&(__Local__60), FKey::__PPO__KeyName() )));
		__Local__63 = FName(TEXT("LeftMouseButton"));
		bpv__WidgetInteraction__pf->ReleasePointerKey(__Local__60);
	}
	return; //KCST_EndOfThread
}
...
void ABP_MotionController_C__pf563933975::bpf__ExecuteUbergraph_BP_MotionController__pf_6(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__WidgetInteraction__pf))
	{
		const UScriptStruct* __Local__65 = FKey::StaticStruct();
		uint8* __Local__66 = (uint8*)FMemory_Alloca(__Local__65->GetStructureSize());
		__Local__65->InitializeStruct(__Local__66);
		FKey& __Local__64 = *reinterpret_cast<FKey*>(__Local__66);
		auto& __Local__67 = (*(AccessPrivateProperty<FName >(&(__Local__64), FKey::__PPO__KeyName() )));
		__Local__67 = FName(TEXT("LeftMouseButton"));
		bpv__WidgetInteraction__pf->PressPointerKey(__Local__64);
	}
	return; //KCST_EndOfThread
}
void ABP_MotionController_C__pf563933975::bpf__BndEvt__ControllerMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	T__Local__68& bpp__Hit__pf = *const_cast<T__Local__68 *>(&bpp__Hit__pf__const);
...
{
	typedef FHitResult  T__Local__69;
	T__Local__69& bpp__SweepResult__pf = *const_cast<T__Local__69 *>(&bpp__SweepResult__pf__const);
...
void ABP_MotionController_C__pf563933975::bpf__RumbleController__pf(float bpp__Intensity__pf)
{
	...
	bpf__ExecuteUbergraph_BP_MotionController__pf_1(3);
}
void ABP_MotionController_C__pf563933975::bpf__InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_0__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_BP_MotionController__pf_6(34);
}
void ABP_MotionController_C__pf563933975::bpf__InpActEvt_MotionControllerTrackpadDownRight_K2Node_InputActionEvent_1__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key_1__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_BP_MotionController__pf_4(46);
}
void ABP_MotionController_C__pf563933975::bpf__UserConstructionScript__pf()
{
	...
	bpfv__CallFunc_GetEnumeratorName_ReturnValue__pf = UKismetNodeHelperLibrary::GetEnumeratorName(CastChecked<UEnum>(CastChecked<UDynamicClass>(ABP_MotionController_C__pf563933975::StaticClass())->UsedAssets[14], ECastCheckedType::NullAllowed), static_cast<uint8>(bpv__Hand__pf));
...
void ABP_MotionController_C__pf563933975::bpf__ReleaseActor__pf()
{
	...
	TScriptInterface<IPickupActorInterface_C> bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf{};
	...
	do
	{
		...
		case 4:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf.SetObject(bpv__AttachedActor__pf);
					void* IAddress = bpv__AttachedActor__pf->GetInterfaceAddress(UPickupActorInterface_C::StaticClass());
					bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf.SetInterface(IAddress);
				}
				else
				{
					bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf.SetObject(nullptr);
				}
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf != nullptr);;
		...
		case 5:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf))
				{
					IPickupActorInterface_C::Execute_bpf__Release__pf(bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface_1__pf.GetObject() );
				}
			}
		case 6:
			{
		...
		case 9:
			{
				...
				{
					IPickupActorInterface_C::Execute_bpf__AltRelease__pf(bpfv__K2Node_DynamicCast_AsPickup_Actor_Interface__pf.GetObject() );
				}
				__CurrentState = 7;
				break;
			}
...
void ABP_MotionController_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{86, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/InputCore.EControllerHand 
	};
...
void ABP_MotionController_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{48, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/HeadMountedDisplay.MotionControllerComponent 
		...
		{41, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.WidgetInteractionComponent 
		...
		{83, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/SteamVR.SteamVRChaperoneComponent 
		...
		{37, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/Engine.EObjectTypeQuery 
		...
		{118, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/VirtualReality/Mannequin/Animations/RightHand_AnimBP.RightHand_AnimBP_C 
		{112, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/VirtualRealityBP/Blueprints/PickupActorInterface.PickupActorInterface_C 
		{119, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedEnum /Game/VirtualRealityBP/Blueprints/GripEnum.GripEnum 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
