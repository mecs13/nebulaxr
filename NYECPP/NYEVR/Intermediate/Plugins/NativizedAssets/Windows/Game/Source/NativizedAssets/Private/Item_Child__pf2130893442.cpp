...
AItem_Child_C__pf2130893442::AItem_Child_C__pf2130893442(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AItem_Child_C__pf2130893442::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__1 = FVector(1.000000, 1.000000, 1.000000);
	bpv__StaticMesh__pf->ComponentTags = TArray<FName> ();
	bpv__StaticMesh__pf->ComponentTags.Reserve(1);
	bpv__StaticMesh__pf->ComponentTags.Add(FName(TEXT("line")));
	...
	(((FBoolProperty*)__Local__4)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), true, 0));
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__Sphere__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(7.000000, 7.000000, 7.000000);
	(((FBoolProperty*)__Local__2)->SetPropertyValue_InContainer((bpv__Sphere__pf), true, 0));
	(((FBoolProperty*)__Local__4)->SetPropertyValue_InContainer((bpv__Sphere__pf), true, 0));
	(((FBoolProperty*)__Local__2)->SetPropertyValue_InContainer((bpv__PointLight__pf), true, 0));
	...
	bpv__RotatingMovement__pf->ComponentTags = TArray<FName> ();
	bpv__RotatingMovement__pf->ComponentTags.Reserve(1);
	bpv__RotatingMovement__pf->ComponentTags.Add(FName(TEXT("line")));
	(((FBoolProperty*)__Local__4)->SetPropertyValue_InContainer((bpv__RotatingMovement__pf), false, 0));
...
void AItem_Child_C__pf2130893442::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AItem_Child_C__pf2130893442::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AItem_C__pf2130893442::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AItem_Child_C__pf2130893442::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{315, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/logo.logo 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AItem_Child_C__pf2130893442::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{104, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/SoftInventory/Items/Item.Item_C 
		{314, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.RotatingMovementComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AItem_Child_C__pf2130893442
{
	FRegisterHelper__AItem_Child_C__pf2130893442()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/SoftInventory/Items/Item_Child"), &AItem_Child_C__pf2130893442::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AItem_Child_C__pf2130893442 Instance;
};
FRegisterHelper__AItem_Child_C__pf2130893442 FRegisterHelper__AItem_Child_C__pf2130893442::Instance;
