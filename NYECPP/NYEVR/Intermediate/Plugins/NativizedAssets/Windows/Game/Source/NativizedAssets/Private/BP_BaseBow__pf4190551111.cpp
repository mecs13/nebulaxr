...
#include "Animbp_Bow__pf1695184374.h"
...
#include "BP_BaseArrow__pf4190551111.h"
...
ABP_BaseBow_C__pf4190551111::ABP_BaseBow_C__pf4190551111(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__SkeletalMesh__pf->AnimClass = UAnimbp_Bow_C__pf1695184374::StaticClass();
	bpv__SkeletalMesh__pf->ClothingSimulationFactory = UClothingSimulationFactoryNv::StaticClass();
	bpv__SkeletalMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_BaseBow_C__pf4190551111::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto& __Local__2 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__SkeletalMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__2 = ECollisionChannel::ECC_GameTraceChannel1;
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__SkeletalMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__3 = ECollisionEnabled::Type::QueryAndPhysics;
	auto& __Local__4 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__SkeletalMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	bpv__SkeletalMesh__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	...
	(((FBoolProperty*)__Local__7)->SetPropertyValue_InContainer((bpv__SkeletalMesh__pf), false, 0));
	bpv__GrabComp__pf = nullptr;
	bpv__StringComp__pf = nullptr;
	bpv__Charge__pf = 0.000000f;
	bpv__Arrow__pf = nullptr;
	bpv__LastCharge__pf = 0.000000f;
	bpv__FloatCurve__pf = CastChecked<UCurveFloat>(CastChecked<UDynamicClass>(ABP_BaseBow_C__pf4190551111::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__ArrowProjectileClass__pf = ABP_BaseArrow_C__pf4190551111::StaticClass();
...
void ABP_BaseBow_C__pf4190551111::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BaseBow_C__pf4190551111::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UAnimbp_Bow_C__pf1695184374::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(ABP_BaseArrow_C__pf4190551111::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_BaseBow_C__pf4190551111::bpf__ExecuteUbergraph_BP_BaseBow__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	ABP_BaseArrow_C__pf4190551111* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	do
	{
		...
		case 2:
			{
				int32  __Local__13 = 0;
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__AmmoCount__pf) : (__Local__13)), 0);
		...
		case 3:
			{
				...
				{
					bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf = bpv__SkeletalMesh__pf->USceneComponent::K2_GetComponentToWorld();
				}
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, bpv__ArrowProjectileClass__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
			}
		case 4:
			{
				if(::IsValid(bpv__SkeletalMesh__pf))
				...
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ABP_BaseArrow_C__pf4190551111>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 5:
			{
		...
		case 6:
			{
				...
				{
					bpv__Arrow__pf->AActor::K2_AttachToComponent(bpv__SkeletalMesh__pf, FName(TEXT("bowString")), EAttachmentRule::KeepWorld, EAttachmentRule::KeepWorld, EAttachmentRule::KeepWorld, true);
				}
			}
		case 7:
			{
				if(::IsValid(bpv__Arrow__pf))
				{
					bpv__Arrow__pf->AActor::K2_AddActorLocalOffset(FVector(20.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_AddActorLocalOffset_SweepHitResult__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 32:
			{
				if(::IsValid(bpv__SkeletalMesh__pf))
				{
					bpv__SkeletalMesh__pf->SetCollisionEnabled(ECollisionEnabled::QueryOnly);
				}
				__CurrentState = -1;
				break;
			}
		case 33:
			{
				AActor::K2_AttachToComponent(bpv__GrabComp__pf, FName(TEXT("None")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::KeepWorld, true);
				__CurrentState = 32;
				break;
			}
		case 34:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpv__GrabComp__pf);
		...
		case 35:
			{
				if(::IsValid(bpv__SkeletalMesh__pf))
				{
					bpfv__CallFunc_GetSocketLocation_ReturnValue__pf = bpv__SkeletalMesh__pf->GetSocketLocation(FName(TEXT("string1")));
				}
				if(::IsValid(b0l__K2Node_Event_AttachTo__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf = b0l__K2Node_Event_AttachTo__pf->USceneComponent::K2_GetComponentLocation();
				}
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf, bpfv__CallFunc_GetSocketLocation_ReturnValue__pf);
				bpfv__CallFunc_VSize_ReturnValue__pf = UKismetMathLibrary::VSize(bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf);
				bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_VSize_ReturnValue__pf, 20.000000);
		...
		case 36:
			{
				bpv__StringComp__pf = b0l__K2Node_Event_AttachTo__pf;
				__CurrentState = 1;
				break;
			}
		case 37:
			{
				bpv__GrabComp__pf = b0l__K2Node_Event_AttachTo__pf;
				__CurrentState = 33;
				break;
			}
		case 39:
...
void ABP_BaseBow_C__pf4190551111::bpf__ExecuteUbergraph_BP_BaseBow__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 8:
			{
				USaveGame*  __Local__14 = ((USaveGame*)nullptr);
				bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf = UGameplayStatics::SaveGameToSlot(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__SaverSubClass__pf) : (__Local__14)), FString(TEXT("test")), 0);
			}
		case 9:
			{
				bpv__Charge__pf = 0.000000;
				__CurrentState = -1;
				break;
			}
		case 10:
			{
				USaveGame*  __Local__15 = ((USaveGame*)nullptr);
				b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf = Cast<UPlayerSaveGameInfo_C__pf205484891>(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__SaverSubClass__pf) : (__Local__15)));
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf != nullptr);;
		...
		case 11:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsPlayer_Save_Game_Info__pf->bpv__AmmoCount__pf = b0l__Temp_int_Variable__pf;
				}
				__CurrentState = 8;
				break;
			}
		...
		case 14:
			{
				if(::IsValid(bpv__Arrow__pf) && ::IsValid(bpv__Arrow__pf->bpv__ProjectileMovement__pf))
				{
					bpv__Arrow__pf->bpv__ProjectileMovement__pf->ProjectileGravityScale = 1.000000;
				}
			}
		case 15:
			{
				if(::IsValid(bpv__Arrow__pf))
				{
					bpfv__CallFunc_GetActorForwardVector_ReturnValue__pf = bpv__Arrow__pf->AActor::GetActorForwardVector();
				}
				if(::IsValid(bpv__FloatCurve__pf))
				{
					bpfv__CallFunc_GetFloatValue_ReturnValue__pf = bpv__FloatCurve__pf->UCurveFloat::GetFloatValue(bpv__Charge__pf);
				}
				bpfv__CallFunc_MapRangeClamped_ReturnValue__pf = UKismetMathLibrary::MapRangeClamped(bpfv__CallFunc_GetFloatValue_ReturnValue__pf, 0.000000, 1.000000, 25.000000, 3000.000000);
				bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(bpfv__CallFunc_GetActorForwardVector_ReturnValue__pf, bpfv__CallFunc_MapRangeClamped_ReturnValue__pf);
				if(::IsValid(bpv__Arrow__pf) && ::IsValid(bpv__Arrow__pf->bpv__ProjectileMovement__pf))
				{
					bpv__Arrow__pf->bpv__ProjectileMovement__pf->Velocity = bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf;
				}
			}
		case 16:
			{
				if(::IsValid(bpv__Arrow__pf) && ::IsValid(bpv__Arrow__pf->bpv__ProjectileMovement__pf))
				{
					bpv__Arrow__pf->bpv__ProjectileMovement__pf->bRotationFollowsVelocity = true;
				}
			}
		case 17:
			{
				bpv__Arrow__pf = ((ABP_BaseArrow_C__pf4190551111*)nullptr);
			}
		case 18:
			{
				AActor::K2_SetActorRelativeRotation(FRotator(0.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetActorRelativeRotation_SweepHitResult__pf, false);
			}
		case 19:
			{
				int32  __Local__16 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf)) ? (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__AmmoCount__pf) : (__Local__16)), 1);
		...
		case 20:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__AmmoCount__pf = b0l__Temp_int_Variable__pf;
				}
				__CurrentState = 10;
				break;
			}
		case 30:
			{
				bpv__StringComp__pf = ((USceneComponent*)nullptr);
			}
		case 31:
			{
				AActor::K2_AttachToComponent(bpv__GrabComp__pf, FName(TEXT("None")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::KeepWorld, true);
...
void ABP_BaseBow_C__pf4190551111::bpf__ExecuteUbergraph_BP_BaseBow__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_IsValid_ReturnValue_2__pf = UKismetSystemLibrary::IsValid(bpv__StringComp__pf);
	...
	if(::IsValid(bpv__SkeletalMesh__pf))
	{
		bpfv__CallFunc_GetSocketTransform_ReturnValue__pf = bpv__SkeletalMesh__pf->GetSocketTransform(FName(TEXT("string1")), ERelativeTransformSpace::RTS_World);
	}
	if(::IsValid(bpv__StringComp__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_3__pf = bpv__StringComp__pf->USceneComponent::K2_GetComponentLocation();
	}
	bpfv__CallFunc_InverseTransformLocation_ReturnValue__pf = UKismetMathLibrary::InverseTransformLocation(bpfv__CallFunc_GetSocketTransform_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_3__pf);
	UKismetMathLibrary::BreakVector(bpfv__CallFunc_InverseTransformLocation_ReturnValue__pf, /*out*/ b0l__CallFunc_BreakVector_X__pf, /*out*/ b0l__CallFunc_BreakVector_Y__pf, /*out*/ b0l__CallFunc_BreakVector_Z__pf);
	bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(b0l__CallFunc_BreakVector_X__pf, -35.000000, 0.000000);
	bpfv__CallFunc_MapRangeClamped_ReturnValue_1__pf = UKismetMathLibrary::MapRangeClamped(bpfv__CallFunc_FClamp_ReturnValue__pf, -35.000000, 0.000000, -1.000000, 0.000000);
	bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(bpfv__CallFunc_MapRangeClamped_ReturnValue_1__pf, -1.000000);
	bpv__Charge__pf = bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf;
	if(::IsValid(bpv__GrabComp__pf))
	{
		bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpv__GrabComp__pf->USceneComponent::K2_GetComponentRotation();
	}
	if(::IsValid(bpv__StringComp__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__StringComp__pf->USceneComponent::K2_GetComponentLocation();
	}
	...
	if(::IsValid(bpv__GrabComp__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = bpv__GrabComp__pf->USceneComponent::K2_GetComponentLocation();
	}
...
void ABP_BaseBow_C__pf4190551111::bpf__ExecuteUbergraph_BP_BaseBow__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	bpv__StringComp__pf = ((USceneComponent*)nullptr);
	bpv__GrabComp__pf = ((USceneComponent*)nullptr);
	bpv__Charge__pf = 0.000000;
	if(::IsValid(bpv__SkeletalMesh__pf))
	{
...
void ABP_BaseBow_C__pf4190551111::bpf__Release__pf()
{
	bpf__ExecuteUbergraph_BP_BaseBow__pf_3(40);
}
void ABP_BaseBow_C__pf4190551111::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_BP_BaseBow__pf_0(39);
}
void ABP_BaseBow_C__pf4190551111::bpf__AltRelease__pf()
{
	bpf__ExecuteUbergraph_BP_BaseBow__pf_1(38);
}
void ABP_BaseBow_C__pf4190551111::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_BaseBow__pf_2(26);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BaseBow_C__pf4190551111::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BaseBow_C__pf4190551111::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{112, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/VirtualRealityBP/Blueprints/PickupActorInterface.PickupActorInterface_C 
		...
		{113, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/Meshes/SyntyBow/Animbp_Bow.Animbp_Bow_C 
		...
		{115, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Bow/BP_BaseArrow.BP_BaseArrow_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_BaseBow_C__pf4190551111
{
	FRegisterHelper__ABP_BaseBow_C__pf4190551111()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Bow/BP_BaseBow"), &ABP_BaseBow_C__pf4190551111::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_BaseBow_C__pf4190551111 Instance;
};
FRegisterHelper__ABP_BaseBow_C__pf4190551111 FRegisterHelper__ABP_BaseBow_C__pf4190551111::Instance;
