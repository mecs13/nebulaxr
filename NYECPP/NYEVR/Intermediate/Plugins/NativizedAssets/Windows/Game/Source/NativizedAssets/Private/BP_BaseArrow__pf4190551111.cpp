...
ABP_BaseArrow_C__pf4190551111::ABP_BaseArrow_C__pf4190551111(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_BaseArrow_C__pf4190551111::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__1 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel1;
	bpv__StaticMesh__pf->BodyInstance.bNotifyRigidBodyCollision = true;
	auto& __Local__2 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__5.Channel = FName(TEXT("Weapon"));
	...
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((bpv__ProjectileMovement__pf), false, 0));
	bpv__HitVelocityLength__pf = 0.000000f;
...
void ABP_BaseArrow_C__pf4190551111::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BaseArrow_C__pf4190551111::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_BaseArrow_C__pf4190551111::bpf__ExecuteUbergraph_BP_BaseArrow__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	FVector bpfv__CallFunc_GetComponentVelocity_ReturnValue_1__pf(EForceInit::ForceInit);
	...
	do
	{
		...
		case 3:
			{
				...
				{
					bpfv__CallFunc_GetComponentVelocity_ReturnValue_1__pf = b0l__K2Node_Event_MyComp__pf->GetComponentVelocity();
				}
				if(::IsValid(b0l__K2Node_Event_OtherComp__pf))
				{
					b0l__K2Node_Event_OtherComp__pf->AddImpulseAtLocation(bpfv__CallFunc_GetComponentVelocity_ReturnValue_1__pf, b0l__K2Node_Event_HitLocation__pf, FName(TEXT("None")));
				}
			}
		case 4:
			{
				if(::IsValid(b0l__K2Node_Event_OtherComp__pf))
				{
					b0l__K2Node_Event_OtherComp__pf->UPrimitiveComponent::IgnoreActorWhenMoving(this, true);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 5:
			{
				if(::IsValid(b0l__K2Node_Event_MyComp__pf))
				{
					bpfv__CallFunc_GetComponentVelocity_ReturnValue__pf = b0l__K2Node_Event_MyComp__pf->GetComponentVelocity();
				}
				bpfv__CallFunc_VSize_ReturnValue__pf = UKismetMathLibrary::VSize(bpfv__CallFunc_GetComponentVelocity_ReturnValue__pf);
				bpv__HitVelocityLength__pf = bpfv__CallFunc_VSize_ReturnValue__pf;
			}
		case 6:
			{
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__HitVelocityLength__pf, 0.024000);
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_Event_Other__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf, ((AController*)nullptr), ((AActor*)nullptr), ((UClass*)nullptr));
			}
		case 7:
			{
				...
				AActor::K2_AttachToComponent(b0l__K2Node_Event_OtherComp__pf, b0l__CallFunc_BreakHitResult_HitBoneName__pf, EAttachmentRule::KeepWorld, EAttachmentRule::KeepWorld, EAttachmentRule::KeepWorld, true);
			}
		case 8:
			{
				bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf = UKismetMathLibrary::RandomFloatInRange(10.000000, 20.000000);
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf, 0.000000, 0.000000);
				AActor::K2_AddActorLocalOffset(bpfv__CallFunc_MakeVector_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_AddActorLocalOffset_SweepHitResult__pf, true);
				__CurrentState = 1;
				break;
			}
		case 9:
		...
		case 10:
			{
				b0l__K2Node_DynamicCast_AsTarget_Float__pf = Cast<ATargetFloat_C__pf1010915279>(b0l__K2Node_Event_Other__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsTarget_Float__pf != nullptr);;
		...
		case 12:
			{
				bpfv__CallFunc_Conv_VectorToTransform_ReturnValue__pf = UKismetMathLibrary::Conv_VectorToTransform(b0l__K2Node_Event_HitLocation__pf);
				if(::IsValid(b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf))
				{
					b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpf__Firework__pf(bpfv__CallFunc_Conv_VectorToTransform_ReturnValue__pf);
				}
			}
		case 13:
			{
...
void ABP_BaseArrow_C__pf4190551111::bpf__ExecuteUbergraph_BP_BaseArrow__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_BaseArrow_C__pf4190551111::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_BaseArrow__pf_1(14);
}
void ABP_BaseArrow_C__pf4190551111::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	typedef FHitResult  T__Local__16;
	T__Local__16& bpp__Hit__pf = *const_cast<T__Local__16 *>(&bpp__Hit__pf__const);
	...
	bpf__ExecuteUbergraph_BP_BaseArrow__pf_0(9);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BaseArrow_C__pf4190551111::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_BaseArrow_C__pf4190551111::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{59, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ProjectileMovementComponent 
		...
		{116, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/TargetFloat.TargetFloat_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_BaseArrow_C__pf4190551111
{
	FRegisterHelper__ABP_BaseArrow_C__pf4190551111()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Bow/BP_BaseArrow"), &ABP_BaseArrow_C__pf4190551111::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_BaseArrow_C__pf4190551111 Instance;
};
FRegisterHelper__ABP_BaseArrow_C__pf4190551111 FRegisterHelper__ABP_BaseArrow_C__pf4190551111::Instance;
