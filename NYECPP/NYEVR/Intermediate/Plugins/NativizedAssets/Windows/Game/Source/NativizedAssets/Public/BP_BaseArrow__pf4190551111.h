...
class ATargetFloat_C__pf1010915279;
class AMotionControllerPawn_C__pf563933975;
#include "BP_BaseArrow__pf4190551111.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/Bow/BP_BaseArrow.BP_BaseArrow_C", OverrideNativeName="BP_BaseArrow_C"))
class ABP_BaseArrow_C__pf4190551111 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Hit Velocity Length", Category="Default", MultiLine="true", OverrideNativeName="HitVelocityLength"))
	float bpv__HitVelocityLength__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_AsTarget_Float"))
	ATargetFloat_C__pf1010915279* b0l__K2Node_DynamicCast_AsTarget_Float__pf;
	...
	ABP_BaseArrow_C__pf4190551111(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_BaseArrow__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_BaseArrow__pf_1(int32 bpp__EntryPoint__pf);
