...
#include "FirstPersonArchery/MyGameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FIRSTPERSONARCHERY_API UClass* Z_Construct_UClass_AMyGameModeBase_NoRegister();
	FIRSTPERSONARCHERY_API UClass* Z_Construct_UClass_AMyGameModeBase();
	ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
	UPackage* Z_Construct_UPackage__Script_FirstPersonArchery();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyGameModeBase_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_FirstPersonArchery,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyGameModeBase, 3013274705);
	template<> FIRSTPERSONARCHERY_API UClass* StaticClass<AMyGameModeBase>()
	{
		return AMyGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyGameModeBase(Z_Construct_UClass_AMyGameModeBase, &AMyGameModeBase::StaticClass, TEXT("/Script/FirstPersonArchery"), TEXT("AMyGameModeBase"), false, nullptr, nullptr, nullptr);
